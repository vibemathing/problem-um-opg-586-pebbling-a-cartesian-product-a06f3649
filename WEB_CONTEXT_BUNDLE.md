...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-586-pebbling-a-cartesian-product-a06f3649-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-586"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-586-pebbling-a-cartesian-product-a06f3649-v1",
      "problem_contract_sha256": "dbcdc7b87f144e7e765a6c9c59b45838a4ddce2835ff0e87eaec028ca4f3cfdf",
      "problem_id": "problem:um-opg-586-pebbling-a-cartesian-product-a06f3649",
      "route_id": "route:um-opg-586-pebbling-a-cartesian-product-a06f3649-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-586-pebbling-a-cartesian-product-a06f3649-source-fidelity-01",
      "graph_id": "graph:um-opg-586-pebbling-a-cartesian-product-a06f3649-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-586-pebbling-a-cartesian-product-a06f3649-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-586-pebbling-a-cartesian-product-a06f3649-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "We let $p(G)$ denote the pebbling number of a graph $G$. Conjecture $p(G_1 \\Box G_2) \\le p(G_1) p(G_2)$."
          },
          "statement_sha256": "be0c9627d8d92abd63474c4031c15d21ea8f239e9c7bf4520a0b4c21172d460c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-586-pebbling-a-cartesian-product-a06f3649-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-586-pebbling-a-cartesian-product-a06f3649-root",
      "route_id": "route:um-opg-586-pebbling-a-cartesian-product-a06f3649-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-586-fe4614b3bcfc",
        "url": "https://www.unsolvedmath.com/problems/OPG-586"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
